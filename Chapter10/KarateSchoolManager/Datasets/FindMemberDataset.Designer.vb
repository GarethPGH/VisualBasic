...
Partial Public Class FindMemberDataset
    ...
    Partial Public Class MembersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddMembersRow(ByVal Last_Name As String, ByVal First_Name As String, ByVal Phone As String, ByVal Date_Joined As Date, ByVal ID As Short) As MembersRow
            Dim rowMembersRow As MembersRow = CType(Me.NewRow,MembersRow)
            Dim columnValuesArray() As Object = New Object() {Last_Name, First_Name, Phone, Date_Joined, ID}
